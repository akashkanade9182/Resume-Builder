            ...
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch defaultChecked={true}  colorScheme='teal' />
                    </div>
                    <hr />
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <FormControl isRequired className='my-2'>
                        <Textarea name='awards' onChange={handleChangeAwards} placeholder='Use comma to separate Achievement' />
                    </FormControl>
                </div>
